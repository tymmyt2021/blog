...
import www.wzb.common.StringUtil;
...
public class IndexJspController extends BaseController {
    ...
    @RequestMapping("/hotpage_list")
    public String findHotpage(Model model, @RequestParam(value = "keyword",required = false) String keyword,
                              @RequestParam(value = "pageNum",required = false) Integer pageNum ,
                              @RequestParam(value = "pageSize",required = false) Integer pageSize) {
        log.info( "===========进入hotpage_list=========" );
        User user = getCurrentUser();
        if(user!=null){
            model.addAttribute( "user",user );
        }
        if(StringUtils.isNotBlank(keyword)){
            ...
            Page<UserContent> page = findAllByUpvote(null,pageNum,pageSize);
            model.addAttribute( "page",page );
        }
        return "../hotpage";
    }
    ...
    public String findMypage(Model model, @RequestParam(value = "keyword",required = false) String keyword,
                              @RequestParam(value = "pageNum",required = false) Integer pageNum ,
                              @RequestParam(value = "pageSize",required = false) Integer pageSize) {
        log.info( "===========进入hotpage_list=========" );
        User user = getCurrentUser();
        ...
        if(StringUtils.isNotBlank(keyword)){
            ...
            Page<UserContent> page = findMyBlog(userContent,pageNum,pageSize);
            model.addAttribute( "page",page );
        }
        return "../mypage";
    }
