...
public class SendEmail {
    ...
    public static void sendEmailMessage(String email,String validateCode) {
       try {
           ...
           String from = "1434651579@qq.com";    //发邮件的出发地（发件人的信箱）
           ...
           MyAuthenticator myauth = new MyAuthenticator(from, "zgmksjgwsqiyicaa");
...
//    session.setDebug(true);
           ...
           // Set the content
           message.setContent( "<a href=\"http://localhost:8090/activecode?email="+email+"&validateCode="+validateCode+"\" target=\"_blank\">请于24小时内点击激活</a>","text/html;charset=gb2312");
           message.saveChanges();
