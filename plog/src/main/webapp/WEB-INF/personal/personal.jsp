    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse navbar-collapse-example">
            ...
            <ul class="nav navbar-nav">
                <li ><a href="ctx}/mypage_list">我的博文</a></li>
            ...
            <ul class="nav navbar-nav">
                <li><a href="${ctx}/writedream">写博文</a></li>
            </ul>
    ...
    <div class="dreamland-content" style="background-color: white">
        <div class="content-bar">
            ...
            <div id="manage-dreamland" style="background-color: #F0F0F0;width: 120px;text-align: center;height: 40px;line-height: 40px;float: left;margin-left: 20px" onclick="manage_dreamland();">
                ...
                <span id="manage-span" style="color: black">管理博文</span>
            ...
            <div id="personal-div" style="background-color: #F0F0F0;width: 120px;text-align: center;height: 40px;line-height: 40px;float: left;margin-left: 20px" onclick="personal_dreamland();">
                ...
                <span id="personal-span"  style="color: black">私密博文</span>

            </div>

        </div>

        <div id="release-dreamland" style="height: 400px;margin-top: 50px;width: 100%">
            <ul style="font-size: 12px" id="release-dreamland-ul">
                ...
                <li class="dreamland-fix">
                    ...
                    <span class="bar-commend">${cont.upvote}赞</span>
            ...
            <div id="release-dreamland-div" style="float: left;position: absolute;bottom: 450px;margin-left: 20px">
        ...
        <div id="update-dreamland" style="height: 400px;margin-top: 50px;width: 100%;display: none" >
            ...
            <div style="float: left;position: absolute;bottom: 450px;margin-left: 20px" id="update-dreamland-div">
        ...
        <div id="personal-dreamland" style="height: 400px;margin-top: 50px;width: 100%;display: none">
            ...
            <div id="personal-dreamland-div" style="float: left;position: absolute;bottom: 450px;margin-left: 20px">
        ...
        <div class="hot-dreamland" style="height: 400px">
            <div style="text-align: center;margin-top: 20px">热门博文
                <span style="color:#B22222 ">hot</span>
            </div>

            <div style="height: 400px;margin-top: 30px;width: 100%" id="hot-dreamland">
            ...
            <div style="float: left;position: absolute;bottom: 0px;margin-left: 20px" id="hot-dreamland-div">
    ...
    <div style="margin-left: 400px;color: white">
        ...
        <div class="foot-nav clearfix" style="position: absolute;left: 0px;margin-top: 20px;margin-left: 400px;text-align: center">
            <div class="foot-copyrights" style="margin-left: 100px">
                ...
                <p style="margin-top: 8px;color: white;font-size: 12px">&copy;www.blog.com 博客网版权所有</p>
            </div>
        </div>
    </div>
</div>
