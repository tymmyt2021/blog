    ...
    <nav class="navbar navbar-inverse">
        ...
        <div id="navbar-menu" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <li><a href="index_list">最新博文</a></li>
                <li><a href="hotpage_list">最热博文</a></li>
                <li><a href="mypage_list">我的博文</a></li>
                <li><a href="${ctx}/list?id=${user.id}">个人空间</a></li>
            </ul>
        </div>

        <form method="post" action="${ctx}/hotpage_list"  id="indexSearchForm"  class="navbar-form navbar-right" role="search" style="margin-top: -35px;margin-right: 10px">
        ...
        <div class="col-md-9"  style="background-color: white;">
            ...
            <div id="page-info" style="position: absolute;width:900px;background-color: #EBEBEB;height: 80px;left: 0px;">
                <ul class="pager pager-loose">
                    ...
                    <c:if test="${page.pageNum > 1}">
                        <li class="previous"><a href="${ctx}/hotpage_list?pageNum=${page.pageNum-1}&&keyword=${keyword}">« 上一页</a></li>
                    </c:if>
                    <c:forEach begin="${page.startPage}" end="${page.endPage}" var="pn">
                        ...
                        <c:if test="${page.pageNum!=pn}">
                            <li ><a href="${ctx}/hotpage_list?pageNum=${pn}&&keyword=${keyword}">${pn}</a></li>
                        </c:if>
                    </c:forEach>
                    ...
                    <c:if test="${page.pageNum<page.pages}">
                        <li><a href="${ctx}/hotpage_list?pageNum=${page.pageNum+1}&&keyword=${keyword}">下一页 »</a></li>
                    </c:if>
            ...
            success:function(data){
                ...
                if(up == "success"){
                    if (cont == -1){
                        ...
                        document.getElementById("down_"+id).innerHTML = value;
                    } else {
                        var num = document.getElementById(id).innerHTML;
                        var value = parseInt(num) + cont;
                        document.getElementById(id).innerHTML = value;
